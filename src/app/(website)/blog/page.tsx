...
const BLOG_POSTS = [
  {
    ...
    excerpt:
      "Kış aylarında sıcak, yaz aylarında serin bir yaşam alanı için prefabrik yapılarda kullanılan modern yalıtım teknolojilerini keşfedin.",
    date: "24 Aralık 2024",
    readTime: "5 dk",
  ...
  },
  {
    ...
    excerpt:
      "Minimalist çizgiler, sürdürülebilir malzemeler ve akıllı ev sistemlerinin prefabrik mimariyle buluştuğu yeni nesil tasarımlar.",
    date: "18 Aralık 2024",
    readTime: "4 dk",
    category: "Mimari",
    image: BlogImg2,
  },
  {
    ...
    excerpt:
      "Ev yaptırmadan önce bilmeniz gereken temel farklar, avantajlar ve maliyet karşılaştırmaları hakkında detaylı rehber.",
    date: "10 Aralık 2024",
    readTime: "7 dk",
    category: "Rehber",
    image: BlogImg3,
  ...
  {
    id: 4,
    title: "Ruhsat Süreçleri Hakkında Bilmeniz Gerekenler",
    excerpt:
      "Arsanıza prefabrik ev yaptırırken izlemeniz gereken yasal prosedürler.",
    date: "05 Aralık 2024",
    readTime: "6 dk",
  ...
  {
    id: 5,
    title: "Küçük Alanlarda Büyük Konfor: Tiny House",
    excerpt:
      "Minimalist yaşamı sevenler için fonksiyonel ve şık mobil ev çözümleri.",
    date: "01 Aralık 2024",
    readTime: "4 dk",
    category: "Yaşam",
    image: BlogImg2,
  ...
  {
    id: 6,
    title: "Prefabrik Evlerin Bakımı Nasıl Yapılır?",
    excerpt: "Yapınızın ömrünü uzatacak pratik bakım ve temizlik önerileri.",
    date: "28 Kasım 2024",
    readTime: "3 dk",
    category: "Bakım",
    image: BlogImg3,
      ...
      <section className="pb-32 ">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mt-24 flex justify-center items-center gap-4">
            <button className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center hover:bg-primary hover:text-white transition-all font-bold">
              1
            </button>
            <button className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center hover:bg-primary hover:text-white transition-all font-bold text-slate-400">
              2
            </button>
            <button className="flex items-center gap-2 pl-4 text-[#49202d] font-bold">
