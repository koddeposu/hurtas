...
export const metadata: Metadata = {
  ...
  description: 'CT Prefabrik ile hayalinizdeki eve kavuşun. TSE onaylı malzemeler, 10 yıl garanti, uygun fiyatlar ve hemen teslim imkanı. 2+1, 3+1, villa tipi prefabrik ev modelleri.',
  keywords: [
    'prefabrik ev',
  ...
  openGraph: {
    title: 'CT Prefabrik | Türkiye\'nin En Kaliteli Prefabrik Ev Üreticisi',
    description: 'TSE onaylı, 10 yıl garantili prefabrik ev modelleri. Hayalinizdeki eve hemen kavuşun.',
