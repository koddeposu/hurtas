...
export function ServiceRegions() {
  return (
    <section className="relative overflow-hidden rounded-[1rem] border border-slate-300  bg-[#eeeff4]  my-10 mx-auto max-w-[1440px]">
      ...
      <div className="relative grid gap-8 px-5 py-8 md:px-8 lg:grid-cols-2 lg:gap-12 lg:p-10">
        ...
        <div className="flex flex-col justify-center max-w-xl">
          <div className="inline-flex items-center gap-2 rounded-lg border border-secondary/20 bg-secondary/10 px-3 py-2 w-max text-[10px] font-black uppercase tracking-[0.2em] text-secondary">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-xs font-black uppercase tracking-wider text-white transition-all hover:bg-primary/90 hover:shadow-lg hover:-translate-y-0.5"
            >
              Modelleri İncele
            ...
            <Link
              href="/iletisim"
              className="inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-5 py-2.5 text-xs font-black uppercase tracking-wider text-slate-700 transition-all hover:border-slate-400 hover:bg-slate-50"
            >
              Teklif Al
            </Link>
          </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 content-center">
          ...
          <article className="rounded-[0.9rem] border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
            <div className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100 text-primary mb-3">
