...
export const WhoWeAre = () => {
  ...
  return (
    <section className="bg-white py-24 px-6 font-[family-name:var(--font-poppins)] text-slate-800">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end gap-8 mb-16">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-emerald-600 font-bold uppercase tracking-[0.2em] text-xs">Akıllı Mimari</span>
            </div>
          ...
          >
            Aktaş ruhundan ilham alarak, inşaat sürecini bir "yük" olmaktan çıkarıp, 30 günde anahtar teslim bir "sanat eserine" dönüştürüyoruz.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          >
            ...
            <div className="p-8 flex justify-between items-center">
              <div>
                <h3 className="text-2xl font-bold mb-1 italic">Milimetrik Hassasiyet</h3>
                <p className="text-slate-400 text-sm">Fabrika ortamında, hata payı olmadan üretim.</p>
              </div>
              <button className="bg-slate-900 text-white p-4 rounded-full hover:bg-emerald-600 transition-colors shadow-lg">
                <ArrowRight size={20} />
              </button>
            </div>
          </motion.div>
          ...
          <div className="md:col-span-4 flex flex-col gap-8">
            ...
            >
              ...
              <ShieldCheck className="text-emerald-500 w-10 h-10 mb-6 relative z-10" />
              <h4 className="text-xl font-bold mb-2">Statik Güven</h4>
              <p className="text-slate-500 text-sm font-medium leading-relaxed">
                Yüksek dayanımlı çelik gövdelerimizle, sismik güvenlikte standartların üzerine çıkıyoruz.
              </p>
            </motion.div>
            ...
            >
              ...
              <h4 className="text-xl font-bold text-emerald-900 mb-1">Ekolojik Yaşam</h4>
              <p className="text-emerald-700/60 text-xs font-bold uppercase tracking-widest">Geri Dönüştürülebilir Yapı</p>
            </motion.div>
          ...
          >
            ...
            <div>
              <div className="text-3xl font-black text-slate-900 tracking-tighter">HIZ</div>
              <p className="text-xs font-bold text-slate-400 uppercase">Zaman Tasarrufu</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-400 uppercase">Estetik Çözümler</p>
            </div>
          </motion.div>
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            className="md:col-span-4 bg-emerald-500 p-10 rounded-[3rem] text-white flex flex-col justify-center items-center text-center"
          >
            <div className="text-4xl font-black tracking-tighter">50+</div>
            <p className="text-xs font-bold uppercase tracking-widest opacity-80">Yıllık Tecrübe</p>
          </motion.div>
