...
const AboutHero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative   font-[family-name:var(--font-poppins)]"
    >
      <div className="container mx-auto lg:px-6 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-6 space-y-8 lg:space-y-12">
            ...
            <div className="relative lg:pl-12 lg:border-l-2 lg:border-slate-200 space-y-4 lg:space-y-8">
              <p className="text-lg lg:text-2xl text-slate-500 font-light leading-relaxed">
                <span className="font-bold text-slate-900">14 yıl</span> önce
                Sakarya'da başlayan serüvenimiz, bugün Türkiye'nin her köşesinde{" "}
                <span className="text-[#165b39] underline decoration-2 underline-offset-8">
                  çelikten yuvalara
                </span>{" "}
                dönüştü.
              </p>
              <p className="text-slate-400 font-medium max-w-md">
                Geleneksel inşaat yöntemlerini teknoloji ve estetikle
                harmanlayarak, modüler yaşamın sınırlarını her gün yeniden
                çiziyoruz.
              </p>
              <div className="flex items-center gap-4 text-[#49202d] font-black text-xs uppercase tracking-widest cursor-pointer">
